...
var
  ...
  Name: string;
begin
  ParamCount := TC.param_count;
  if ParamCount >= 1 then
  begin
    Parameter := TC.parameter(0);
...
begin
  ...
  try
    ...
    WriteLn(F);
    WriteLn(F, '    (* CORBA function names for TypeCodes, per CORBA 7.6.1, p.139 *)');
    WriteLn(F, '    function kind: TCKind;');
    WriteLn(F, '    function equal(y: TypeCode): CORBABoolean;');
    WriteLn(F, '    function param_count: LongInt;');
    WriteLn(F, '    function parameter(index: LongInt): any;');
    WriteLn(F, '    (*');
    WriteLn(F, '     *  The following are IBM TypeCode extensions');
    WriteLn(F, '     *)');
    WriteLn(F, '    function alignment: SmallInt;');
    ...
    WriteLn(F, '    function size: LongInt;');
    WriteLn(F);
    ...
    WriteLn(F);
    WriteLn(F, 'function TypeCode.kind: TCKind;');
    WriteLn(F, 'var');
    WriteLn(F, '  LocalEnv: Environment;');
    WriteLn(F, 'begin');
    WriteLn(F, '  SOM_InitEnvironment(@LocalEnv);');
    ...
    WriteLn(F);
    WriteLn(F, 'function TypeCode.param_count: LongInt;');
    WriteLn(F, 'var');
    WriteLn(F, '  LocalEnv: Environment;');
    WriteLn(F, 'begin');
    WriteLn(F, '  SOM_InitEnvironment(@LocalEnv);');
    ...
    WriteLn(F);
    WriteLn(F, 'function TypeCode.parameter(index: LongInt): any;');
    WriteLn(F, 'var');
    WriteLn(F, '  LocalEnv: Environment;');
    WriteLn(F, 'begin');
    WriteLn(F, '  SOM_InitEnvironment(@LocalEnv);');
    ...
    WriteLn(F);
    WriteLn(F, 'function TypeCode.alignment: SmallInt;');
    WriteLn(F, 'var');
    WriteLn(F, '  LocalEnv: Environment;');
    WriteLn(F, 'begin');
    WriteLn(F, '  SOM_InitEnvironment(@LocalEnv);');
    ...
    WriteLn(F);
    WriteLn(F, 'function TypeCode.size: LongInt;');
    WriteLn(F, 'var');
    WriteLn(F, '  LocalEnv: Environment;');
    WriteLn(F, 'begin');
    WriteLn(F, '  SOM_InitEnvironment(@LocalEnv);');
