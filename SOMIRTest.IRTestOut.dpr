...
begin
  ...
  try
    ...
    WriteLn(F, '    { hide or reimplement TObject methods }');
    WriteLn(F, '  protected');
    WriteLn(F, '    class procedure Create; reintroduce;');
    WriteLn(F, '  public');
    WriteLn(F, '    procedure Free; reintroduce;');
    WriteLn(F, '  protected');
    WriteLn(F, '    class procedure InitInstance; reintroduce;');
    WriteLn(F, '  public');
    WriteLn(F, '    procedure CleanupInstance; reintroduce;');
    WriteLn(F, '    function ClassType: SOMClass; reintroduce;');
    WriteLn(F, '  protected');
    WriteLn(F, '    class procedure ClassName; reintroduce;');
    WriteLn(F, '    class procedure ClassNameIs; reintroduce;');
    WriteLn(F, '    class procedure ClassParent; reintroduce;');
    WriteLn(F, '    class procedure ClassInfo; reintroduce;');
    WriteLn(F, '    class procedure InstanceSize; reintroduce;');
    WriteLn(F, '    class procedure InheritsFrom; reintroduce;');
    WriteLn(F, '    class procedure MethodAddress; reintroduce;');
    WriteLn(F, '    class procedure MethodName; reintroduce;');
    WriteLn(F, '    procedure FieldAddress; reintroduce;');
    WriteLn(F, '    procedure GetInterface; reintroduce;');
    WriteLn(F, '    class procedure GetInterfaceEntry; reintroduce;');
    WriteLn(F, '    class procedure GetInterfaceTable; reintroduce;');
    WriteLn(F, '    procedure SafeCallException; reintroduce;');
    WriteLn(F, '  public');
    WriteLn(F, '    procedure AfterConstruction; reintroduce;');
    WriteLn(F, '    procedure BeforeDestruction; reintroduce;');
    WriteLn(F, '  protected');
    WriteLn(F, '    procedure Dispatch; reintroduce;');
    WriteLn(F, '    procedure DefaultHandler; reintroduce;');
    WriteLn(F, '    class procedure NewInstance; reintroduce;');
    WriteLn(F, '  public');
    WriteLn(F, '    procedure FreeInstance; reintroduce;');
    ...
    WriteLn(F, '    procedure CleanupInstance; reintroduce;');
    WriteLn(F, '  protected');
    WriteLn(F, '    procedure ClassType; reintroduce;');
    WriteLn(F, '  public');
    WriteLn(F, '    class function ClassName: string; reintroduce;');
    WriteLn(F, '    class function ClassNameIs(const Name: string): Boolean; reintroduce;');
    WriteLn(F, '  protected');
    ...
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.Create;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.Free;');
    WriteLn(F, 'begin');
    WriteLn(F, '  if Assigned(Self) then SOMObject(Self).somFree;');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.InitInstance;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    ...
    WriteLn(F, 'begin');
    WriteLn(F, '  Result := SOMObject(Self).somGetClass;');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.ClassName;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.ClassNameIs;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.ClassParent;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.ClassInfo;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.InstanceSize;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.InheritsFrom;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.MethodAddress;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.MethodName;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.FieldAddress;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.GetInterface;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.GetInterfaceEntry;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.GetInterfaceTable;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.SafeCallException;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.AfterConstruction;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { in SOM that is being done by cooperative metaclass }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.BeforeDestruction;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { in SOM that is being done by cooperative metaclass }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.Dispatch;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure SOMObjectBase.DefaultHandler;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure SOMObjectBase.NewInstance;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    ...
    WriteLn(F, 'begin');
    WriteLn(F, '  SOMObject(Self).somFree;');
    WriteLn(F, 'end;');
    WriteLn(F);
    ...
    WriteLn(F, 'begin');
    WriteLn(F, '  if Assigned(Self) then');
    WriteLn(F, '  begin');
    WriteLn(F, '    FreeInstance;');
    WriteLn(F, '  end;');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.InitInstance;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.CleanupInstance;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { TypeCode_free does everything at the same time, so no separate Cleanup }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.ClassType;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class function TypeCode.ClassName: string;');
    WriteLn(F, 'begin');
    WriteLn(F, '  Result := ''TypeCode'';');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class function TypeCode.ClassNameIs(const Name: string): Boolean;');
    WriteLn(F, 'begin');
    WriteLn(F, '  Result := Name = ''TypeCode'';');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.ClassParent;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.ClassInfo;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.InstanceSize;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.InheritsFrom;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.MethodAddress;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.MethodName;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.FieldAddress;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.GetInterface;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.GetInterfaceEntry;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.GetInterfaceTable;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.SafeCallException;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.AfterConstruction;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { nothing to do }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.BeforeDestruction;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { nothing to do }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.Dispatch;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.DefaultHandler;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    WriteLn(F, 'class procedure TypeCode.NewInstance;');
    WriteLn(F, 'begin');
    WriteLn(F, '  { hide this method }');
    WriteLn(F, 'end;');
    WriteLn(F);
    ...
    WriteLn(F);
    WriteLn(F, 'procedure TypeCode.FreeInstance;');
    WriteLn(F, 'var');
    WriteLn(F, '  LocalEnv: Environment;');
    WriteLn(F, 'begin');
    WriteLn(F, '  SOM_InitEnvironment(@LocalEnv);');
