...
type
  ...
  public
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
    procedure somDefaultConstCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    procedure somDefaultVCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    procedure somDefaultConstVCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultConstAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
    function somDefaultVAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
    function somDefaultConstVAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
    procedure somInit;
    procedure somUninit;
    procedure somFree;
    ...
    function somRespondsTo(mId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): CORBABoolean;
    function somDispatch(out retValue: ^{...}; methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; ap: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): CORBABoolean;
    function somClassDispatch(clsObj: SOMClass; out retValue: ^{...}; methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; ap: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): CORBABoolean;
  ...
  private
    ...
    function _get_somModifiers: _IDL_Sequence_{...};
    procedure _set_somModifiers(somModifiers: _IDL_Sequence_{...});
  public
    function within: _IDL_Sequence_{...};
    function describe: record {...} end;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
    ...
    property somModifiers: _IDL_Sequence_{...} read _get_somModifiers write _set_somModifiers;
  end;
  ...
  private
    ...
    function _get_mode: type LongWord { enumeration };
    procedure _set_mode(mode: type LongWord { enumeration });
    function _get_name: CORBAString;
    procedure _set_name(name: CORBAString);
    function _get_id: CORBAString;
    procedure _set_id(id: CORBAString);
  ...
  public
    ...
    property mode: type LongWord { enumeration } read _get_mode write _set_mode;
    property name: CORBAString read _get_name write _set_name;
    property id: CORBAString read _get_id write _set_id;
    property defined_in: CORBAString read _get_defined_in write _set_defined_in;
    property somModifiers: _IDL_Sequence_{...} read _get_somModifiers write _set_somModifiers;
  ...
  BOA = class
    ...
    { Found item: somObjectOffsets }
  public
    function create(id: _IDL_Sequence_{...}; intf: InterfaceDef; impl: ImplementationDef): SOMDObject;
    procedure dispose(obj: SOMDObject);
    function get_id(obj: SOMDObject): _IDL_Sequence_{...};
    function get_principal(obj: SOMDObject; req_ev: record {...} end): Principal;
    procedure set_exception(major: type LongWord { enumeration }; userid: CORBAString; param: ^{...});
  ...
  private
    ...
    procedure _set_somtTargetFile(somtTargetFile: ^{...});
    ...
    function _get_somtTargetType: type LongWord { enumeration };
    procedure _set_somtTargetType(somtTargetType: type LongWord { enumeration });
  ...
  public
    ...
    function somtOpenSymbolsFile(file: CORBAString; mode: CORBAString): ^{...};
    ...
    property somtTargetType: type LongWord { enumeration } read _get_somtTargetType write _set_somtTargetType;
  ...
  Container = class
    ...
    { Found item: somObjectOffsets }
  public
    function contents(limit_type: CORBAString; exclude_inherited: CORBABoolean): _IDL_Sequence_{...};
    function lookup_name(search_name: CORBAString; levels_to_search: LongInt; limit_type: CORBAString; exclude_inherited: CORBABoolean): _IDL_Sequence_{...};
    function describe_contents(limit_type: CORBAString; exclude_inherited: CORBABoolean; max_returned_objs: LongInt): _IDL_Sequence_{...};
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  public
    ...
    procedure somdDispatchMethod(somobj: SOMObject; out retValue: ^{...}; methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; ap: {unknown type with TypeCode_kind = TypeCode_tk_foreign});
    ...
    function somdCreateFactory(className: CORBAString; props: _IDL_Sequence_{...}): SOMObject;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  SOMDForeignMarshaler = class
    ...
    { Found item: somObjectOffsets }
  public
    procedure marshal(latent_param: CORBAString; dataPtr: ^{...}; direction: type LongWord { enumeration }; function: type LongWord { enumeration }; streamio: CosStream::StreamIO);
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  private
    ...
    procedure _set_somtEmitterName(somtEmitterName: CORBAString);
  public
    procedure somtAddClassEntry(cls: ^{...});
    function emitInitTermFunctions(file: CORBAString; ext: CORBAString): ^{...};
  ...
  public
    ...
    function find_all_aliases(out impl_aliases: _IDL_Sequence_{...}): LongWord;
    function find_all_impldefs(out outimpldefs: _IDL_Sequence_{...}): LongWord;
    ...
    function find_impldef_by_class(classname: CORBAString): _IDL_Sequence_{...};
    ...
    function find_classes_by_impldef(implid: CORBAString): _IDL_Sequence_{...};
    function add_class_to_all(classname: CORBAString): LongWord;
    function add_class_with_properties(implid: CORBAString; classname: CORBAString; pvl: _IDL_Sequence_{...}): LongWord;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  InterfaceDef = class
    ...
    { Found item: ContainerDescription }
  private
    function _get_base_interfaces: _IDL_Sequence_{...};
    procedure _set_base_interfaces(base_interfaces: _IDL_Sequence_{...});
    ...
    procedure _set_somModifiers(somModifiers: _IDL_Sequence_{...});
  public
    function describe_interface: record {...} end;
    function within: _IDL_Sequence_{...};
    function describe: record {...} end;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    ...
    function lookup_name(search_name: CORBAString; levels_to_search: LongInt; limit_type: CORBAString; exclude_inherited: CORBABoolean): _IDL_Sequence_{...};
    function describe_contents(limit_type: CORBAString; exclude_inherited: CORBABoolean; max_returned_objs: LongInt): _IDL_Sequence_{...};
    property base_interfaces: _IDL_Sequence_{...} read _get_base_interfaces write _set_base_interfaces;
  ...
  public
    ...
    function to_idl_form: _IDL_Sequence_{...};
    procedure from_idl_form(n: _IDL_Sequence_{...});
    procedure destroy;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
  ...
  NVList = class
    ...
    { Found item: somObjectOffsets }
  public
    function add_item(item_name: CORBAString; item_type: TypeCode; value: ^{...}; value_len: LongInt; item_flags: LongWord): LongWord;
    function free: LongWord;
    function free_memory: LongWord;
    function get_count(out count: LongInt): LongWord;
    function set_item(item_number: LongInt; item_name: CORBAString; item_type: TypeCode; value: ^{...}; value_len: LongInt; item_flags: LongWord): LongWord;
    function get_item(item_number: LongInt; out item_name: CORBAString; out item_type: TypeCode; out value: ^{...}; out value_len: LongInt; out item_flags: LongWord): LongWord;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  private
    ...
    function _get_mode: type LongWord { enumeration };
    procedure _set_mode(mode: type LongWord { enumeration });
    function _get_contexts: _IDL_Sequence_{...};
    procedure _set_contexts(contexts: _IDL_Sequence_{...});
    function _get_name: CORBAString;
    procedure _set_name(name: CORBAString);
    function _get_id: CORBAString;
    procedure _set_id(id: CORBAString);
  ...
  public
    ...
    property mode: type LongWord { enumeration } read _get_mode write _set_mode;
    property contexts: _IDL_Sequence_{...} read _get_contexts write _set_contexts;
    property name: CORBAString read _get_name write _set_name;
    property id: CORBAString read _get_id write _set_id;
    property defined_in: CORBAString read _get_defined_in write _set_defined_in;
    property somModifiers: _IDL_Sequence_{...} read _get_somModifiers write _set_somModifiers;
  ...
  public
    ...
    function list_initial_services: _IDL_Sequence_{...};
  ...
  Request = class
    ...
    { Found item: somObjectOffsets }
  public
    function add_arg(name: CORBAString; arg_type: TypeCode; value: ^{...}; len: LongInt; arg_flags: LongWord): LongWord;
  ...
  public
    ...
    procedure somtSetEntryStruct(var es: ^{...});
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  private
    ...
    function _get_somtVisibility: type LongWord { enumeration };
    function _get_somtEntryName: CORBAString;
    procedure _set_somtEntryName(somtEntryName: CORBAString);
    function _get_somtElementType: LongWord;
    procedure _set_somtElementType(somtElementType: LongWord);
  ...
  public
    ...
    property somtVisibility: type LongWord { enumeration } read _get_somtVisibility write _set_somtVisibility;
    property somtEntryName: CORBAString read _get_somtEntryName write _set_somtEntryName;
    property somtElementType: LongWord read _get_somtElementType write _set_somtElementType;
    property somtElementTypeName: CORBAString read _get_somtElementTypeName write _set_somtElementTypeName;
    property somtEntryComment: CORBAString read _get_somtEntryComment write _set_somtEntryComment;
  ...
  SOMTParameterEntryC = class
    ...
    { Found item: somObjectOffsets }
  private
    function _get_somtParameterDirection: type LongWord { enumeration };
  ...
  public
    ...
    procedure somDumpSelf(level: LongInt);
    procedure somDumpSelfInt(level: LongInt);
    property somtParameterDirection: type LongWord { enumeration } read _get_somtParameterDirection write _set_somtParameterDirection;
  ...
  SOMTTemplateOutputC = class
    ...
    { Found item: somObjectOffsets }
  private
    function _get_somtCommentStyle: type LongWord { enumeration };
    procedure _set_somtCommentStyle(somtCommentStyle: type LongWord { enumeration });
  ...
  public
    ...
    procedure somtSetOutputFile(var fp: {unknown type with TypeCode_kind = TypeCode_tk_foreign});
    ...
    procedure somtReadSectionDefinitions(var fp: {unknown type with TypeCode_kind = TypeCode_tk_foreign});
    ...
    procedure somDumpSelf(level: LongInt);
    procedure somDumpSelfInt(level: LongInt);
    property somtCommentStyle: type LongWord { enumeration } read _get_somtCommentStyle write _set_somtCommentStyle;
  ...
  private
    ...
    function _get_somInstanceDataOffsets: _IDL_Sequence_{...};
    function _get_somDirectInitClasses: _IDL_Sequence_{...};
  public
    function somNew: SOMObject;
    function somNewNoInit: SOMObject;
    function somRenew(obj: ^{...}): SOMObject;
    function somRenewNoInit(obj: ^{...}): SOMObject;
    function somRenewNoZero(obj: ^{...}): SOMObject;
    function somRenewNoInitNoZero(obj: ^{...}): SOMObject;
    function somAllocate(size: LongInt): ^{...};
    procedure somDeallocate(memptr: ^{...});
    ...
    function somClassOfNewClassWithParents(newClassName: CORBAString; parents: _IDL_Sequence_{...}; explicitMeta: SOMClass): SOMClass;
    procedure somInitMIClass(inherit_vars: LongWord; className: CORBAString; parentClasses: _IDL_Sequence_{...}; dataSize: LongInt; dataAlignment: LongInt; maxNDMethods: LongInt; majorVersion: LongInt; minorVersion: LongInt);
    function somAddStaticMethod(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; methodDescriptor: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; method: ^{...}; redispatchStub: ^{...}; applyStub: ^{...}): ^{...};
    procedure somOverrideSMethod(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; method: ^{...});
    procedure somClassReady;
    procedure somAddDynamicMethod(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; methodDescriptor: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; methodImpl: ^{...}; applyStub: ^{...});
    ...
    function somGetParents: _IDL_Sequence_{...};
    function somGetInstanceSize: LongInt;
    function somGetInstancePartSize: LongInt;
    function somGetInstanceToken: ^{...};
    function somGetMemberToken(memberOffset: LongInt; instanceToken: ^{...}): ^{...};
    function somGetClassMtab: ^{...};
    function somGetClassData: ^{...};
    procedure somSetClassData(cds: ^{...});
    function somGetMethodDescriptor(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): {unknown type with TypeCode_kind = TypeCode_tk_foreign};
    function somGetMethodIndex(id: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): LongInt;
    function somGetMethodToken(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): ^{...};
    function somGetNthMethodInfo(n: LongInt; out descriptor: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): {unknown type with TypeCode_kind = TypeCode_tk_foreign};
    function somGetMarshalPlan(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): ^{...};
    function somGetMethodData(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; out md: record {...} end): CORBABoolean;
    function somGetNthMethodData(n: LongInt; out md: record {...} end): CORBABoolean;
    function somFindMethod(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; out m: ^{...}): CORBABoolean;
    function somFindMethodOk(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; out m: ^{...}): CORBABoolean;
    function somFindSMethod(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): ^{...};
    function somFindSMethodOk(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): ^{...};
    function somLookupMethod(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): ^{...};
    function somGetApplyStub(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): ^{...};
    ...
    function somSupportsMethod(mId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): CORBABoolean;
    function somDefinedMethod(method: ^{...}): ^{...};
    function somMethodImplOwner(var md: record {...} end): SOMClass;
    function somGetRdStub(methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): ^{...};
    ...
    property somInstanceDataOffsets: _IDL_Sequence_{...} read _get_somInstanceDataOffsets write _set_somInstanceDataOffsets;
    property somDirectInitClasses: _IDL_Sequence_{...} read _get_somDirectInitClasses write _set_somDirectInitClasses;
  end;
  ...
  private
    ...
    function _get_somDirectInitClasses: _IDL_Sequence_{...};
  public
    function sommBeforeMethod(object: SOMObject; methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; ap: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): CORBABoolean;
    procedure sommAfterMethod(object: SOMObject; methodId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; returnedvalue: ^{...}; ap: {unknown type with TypeCode_kind = TypeCode_tk_foreign});
    function somNew: SOMObject;
    function somNewNoInit: SOMObject;
    function somRenew(obj: ^{...}): SOMObject;
    function somRenewNoInit(obj: ^{...}): SOMObject;
  ...
  private
    ...
    function _get_somRegisteredClasses: _IDL_Sequence_{...};
  public
    function somLoadClassFile(classId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; majorVersion: LongInt; minorVersion: LongInt; file: CORBAString): SOMClass;
    function somLocateClassFile(classId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; majorVersion: LongInt; minorVersion: LongInt): CORBAString;
    procedure somRegisterClass(classObj: SOMClass);
    procedure somRegisterClassLibrary(libraryName: CORBAString; libraryInitRtn: ^{...});
    ...
    function somGetRelatedClasses(classObj: SOMClass): ^{...};
    function somClassFromId(classId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): SOMClass;
    function somFindClass(classId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; majorVersion: LongInt; minorVersion: LongInt): SOMClass;
    function somFindClsInFile(classId: {unknown type with TypeCode_kind = TypeCode_tk_foreign}; majorVersion: LongInt; minorVersion: LongInt; file: CORBAString): SOMClass;
    ...
    property somRegisteredClasses: _IDL_Sequence_{...} read _get_somRegisteredClasses write _set_somRegisteredClasses;
  end;
  ...
  public
    function sommProxyDispatch(out returnBufferPointer: ^{...}; dispatchInfo: record {...} end; ap: {unknown type with TypeCode_kind = TypeCode_tk_foreign}): CORBABoolean;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  public
    ...
    procedure release;
    function create_request(ctx: Context; operation: CORBAString; arg_list: NVList; var result: record {...} end; out request: Request; req_flags: LongWord): LongWord;
    function create_request_args(operation: CORBAString; out arg_list: NVList; out result: record {...} end): LongWord;
    procedure somDefaultInit(ctrl: ^{...});
    procedure somDestruct(doFree: Byte; ctrl: ^{...});
    procedure somDefaultCopyInit(ctrl: ^{...}; fromObj: SOMObject);
    function somDefaultAssign(ctrl: ^{...}; fromObj: SOMObject): SOMObject;
  ...
  public
    ...
    function somdFindServersByClass(objclass: CORBAString): _IDL_Sequence_{...};
  ...
  public
    ...
    procedure change_id(objref: SOMDObject; id: _IDL_Sequence_{...});
    function create_constant(id: _IDL_Sequence_{...}; intf: InterfaceDef; impl: ImplementationDef): SOMDObject;
    ...
    function get_service_contexts(obj: SOMDObject): _IDL_Sequence_{...};
    function create(id: _IDL_Sequence_{...}; intf: InterfaceDef; impl: ImplementationDef): SOMDObject;
    procedure dispose(obj: SOMDObject);
    function get_id(obj: SOMDObject): _IDL_Sequence_{...};
    function get_principal(obj: SOMDObject; req_ev: record {...} end): Principal;
  ...
  SOMParentDerivedMetaclass = class
    ...
    { Found item: somObjectOffsets }
  private
    function _get_somNonDerivedFrontier: _IDL_Sequence_{...};
    function _get_somDataAlignment: LongInt;
    function _get_somInstanceDataOffsets: _IDL_Sequence_{...};
    function _get_somDirectInitClasses: _IDL_Sequence_{...};
  public
    ...
    procedure somDumpSelf(level: LongInt);
    procedure somDumpSelfInt(level: LongInt);
    property somNonDerivedFrontier: _IDL_Sequence_{...} read _get_somNonDerivedFrontier write _set_somNonDerivedFrontier;
    property somDataAlignment: LongInt read _get_somDataAlignment write _set_somDataAlignment;
    property somInstanceDataOffsets: _IDL_Sequence_{...} read _get_somInstanceDataOffsets write _set_somInstanceDataOffsets;
    property somDirectInitClasses: _IDL_Sequence_{...} read _get_somDirectInitClasses write _set_somDirectInitClasses;
  end;
